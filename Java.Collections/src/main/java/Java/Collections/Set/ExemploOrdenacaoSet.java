...
Série 1 = Nome: Strange Things, genero: Drama, tempoEpisodio: 45
Série 2 = nome: Game of Thrones, genero: Fantasia, tempoEpisodio: 60
Série 3 = nome: La casa de papel, genero: Ação, tempoEpisodio: 45
*/
...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<>(){{
            add(new Serie("Strange Things", "Drama", 45));
            add(new Serie("Game of Thrones", "Fantasia", 60));
            add(new Serie("La casa de papel", "Ação", 45));
        }};
...
class Serie implements Comparable<Serie>{
   ...
   final private Integer tempoEpisodio;
